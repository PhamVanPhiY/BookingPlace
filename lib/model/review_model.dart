...
class ReviewModel {
  ...
  ReviewModel({this.contact, this.text, this.rating, this.dateTime, this.reviewerName});
  ...
  ReviewModel.fromFirestore(Map<String, dynamic> data, ContactModel reviewer)
      : contact = reviewer,
        ...
        reviewerName = data['reviewerName'] ?? reviewer.firstName ?? 'Anonymous'; // Kiểm tra lại nếu không có tên từ Firestore
